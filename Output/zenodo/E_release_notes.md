...
- Updated `B_README.md` and `B_README.txt`:
  ...
  - Added a new "Code, Pretrained Model & Web Platform" section linking to the [A-eye GitHub repository](https://github.com/jaimebarran/a-eye).
  - Added a description of the [web platform](https://aeye.hevs.ch), where users can upload a T1-weighted MRI scan to run the segmentation pipeline directly in their browser, explore the MR-Eye atlases in interactive 3D, and inspect the resulting morphometric measurements.
