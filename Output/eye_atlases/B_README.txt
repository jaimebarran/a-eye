...
Then, we registered them to the combined and male eye atlases for MNI152 and Colin27, respectively, project its labels onto the cropped spaces, and finally transpose them back into the original spaces (inverse cropping).
